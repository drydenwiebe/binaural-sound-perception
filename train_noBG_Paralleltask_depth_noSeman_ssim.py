...
parser.add_argument('--arch', type=str, default='network.deepv3_noBG_Paralleltask_depth_noSeman_ssim.DeepWV3Plus',
...
def validate(val_loader, net, criterion, optim, curr_epoch, writer):
    ...
    for val_idx, data in enumerate(val_loader):
        ...
        if val_idx % 100 == 0:
            ...
            output_directory = "/home/drydenw/projects/rrg-kyi/drydenw/binaural-sound-perception/logs/ckpt/default/Omni-network.deepv3_noBG_Paralleltask_depth_noSeman_ssim/"
